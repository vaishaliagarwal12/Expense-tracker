    ...
    <div className="space-y-6 animate-fade-in pb-12">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        <div className="fin-card p-5 space-y-2">
          ...
          <p className="text-2xl font-black text-slate-900 dark:text-white">{format(summary.totalMonthly)}</p>
        ...
        <div className="fin-card p-5 space-y-2">
          ...
          <p className="text-2xl font-black text-slate-900 dark:text-white">{format(summary.totalAnnual)}</p>
      ...
      {loading ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          {subscriptions.map(sub => (
            <div key={sub.id} className="fin-card fin-card-hover p-6 flex flex-col justify-between space-y-4">
              <div className="flex items-center justify-between">
                <div>
